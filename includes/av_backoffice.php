...
<div class="avpres_wrap">
    <div>
        <img src="<?php echo $logoHeader; ?>" alt="Netreviews" class="av_logo_header" style="">
    </div>
    <div class="avpres_col_left">
        <h1 class="av_tiempo"><?php _e('Use the voice of your customers and boost your sales', 'av') ?> !</h1>
        <p>
            <span><?php _e(
                'A turnkey solution for collecting, managing, analyzing, and publishing consumer reviews online, Verified Reviews puts the customer experience at the service of your brand',
                'av') ?>.</span>
        </p>
        <p>
            <span><?php _e('Measure your shopper satisfaction and improve the customer experience', 'av') ?>.</span>
            <span><?php _e(
                'After an online or in-store order, easily track and measure your customers\' satisfaction and improve their shopping experiences',
                'av'
            ) ?>.</span>
        </p>
    </div>
    <div class="av_div_pictos">
        <div class="av_picto">
            <img src="<?php echo $dirImg.'av_picto_1.png'; ?>" class="av_picto" alt="product visibility" />
            <p><b><?php _e('Product Visibility','av') ?></b></p>
        </div>
        <div class="av_picto">
            <img src="<?php echo $dirImg.'av_picto_2.png'; ?>" class="av_picto" alt="client ratings" />
            <p><b><?php _e('Measurement, analysis, and valuation of the customer experience','av') ?></b></p>
        </div>
        <div class="av_picto">
            <img src="<?php echo $dirImg.'av_picto_3.png'; ?>" class="av_picto" alt="control and reputation"/>
            <p><b><?php _e('Control and improvement of e-reputation','av') ?></b></p>
        </div>
        <div class="av_picto">
            <img src="<?php echo $dirImg.'av_picto_4.png'; ?>" class="av_picto" alt="more money"/>
            <p><b><?php _e('Increase in conversions','av') ?></b></p>
        </div>
    </div>
    <div class="av_div_button_redirect">
        <a href=<?php _e('http://www.verified-reviews.co.uk/', 'av'); ?> target="_blank" >
            <button class="av_button_redirect"><?php _e('Subscribe','av') ?></button>
        </a>
    </div>
    <div class="avpres_col_bottom">
        <img src="<?php echo $dirImg.'Google_logo.svg.png'; ?>" alt="google logo" class="av_partners_logo">
        <img src="<?php echo $dirImg.'Bing_logo.svg.png'; ?>" alt="Bing logo" class="av_partners_logo">
    </div>
</div>
    ...
    <div class="panelaccordion panelaccordionconfig" style="max-height: 10000px;">
        ...
        <form class="champ form-horizontal col-md-4" name="av_form_conf" method="post">
            ...
            <?php if (!empty($WPML_config)) {
                ...
                <u>
                    <p class="paragraphsecretkeyWpml">
                        <?php _e(
                            ...
                            <div class="form-group">
                                <label for="s_key"><b><?php _e('Secret Key : ', 'av'); ?></b></label><input
                                        ...
                                        value="<?php if (isset($s_keyArray[$key]) && $s_keyArray[$key] != null) :
                                            echo htmlentities("$s_keyArray[$key]");
                                                endif; ?>"/>
                            </div>
                            <img src='../wp-content/plugins/sitepress-multilingual-cms/res/flags/<?php echo $value; ?>'
                                    alt='<?php echo htmlentities($value); ?>' height="50px" style="float: right;">
                            <div class="form-group">
                                <label for="id_web"><b><?php _e('ID Website : ', 'av'); ?></b></label><input
                                        ...
                                        value="<?php if (isset($id_webArray[$key]) && $id_webArray[$key] != null) :
                                            echo htmlentities("$id_webArray[$key]");
                                                endif; ?>"/>
                            </div>
                        </div>
                    <?php
        ...
        <form class="champ form-horizontal col-md-4" name="av_form_design" method="post">
                        ...
                        <div class="templatewidget_div">
                            <div class="img_widget_to_choose <?php if ($designWidget == 3) {
                                ...
                                <div class="av_product_award">
                                    ...
                                    <img id="sceau" src="<?php echo htmlentities($logoFile); ?>" alt="netreviews seal">
                                </div>
                            </div>
                        </div>

                        <input id="widget_version_chosen" type="hidden" name="widget_version_chosen"
                               value="<?php echo htmlentities($designWidget); ?>">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="choose_template">
                        ...
                        <input id="template_version_chosen" type="hidden" name="template_version_chosen"
                               value="<?php echo htmlentities($choosenTemplate); ?>">
                    </td>
                </tr>
            </table>
            <table class="table_design_details">
                    ...
                    <td class="responsive-align">
                        <input type="number" id="inputNumberReviews" name="numberReviews" style="border-radius: 5px;"
                               value='<?php if (!empty($numberReviews)) {
                                    echo htmlentities($numberReviews);
                                      } else {
                                          echo 5;
                                      } ?>' min=1>
                    </td>
                ...
                <tr class="responsive-specific-css">
                    ...
                    <td>
                        <textarea name="specificStyle" rows="5" cols="50"><?php echo htmlentities($specificStyle); ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
